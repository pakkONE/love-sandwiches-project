...
def get_sales_data():
    ...
    while True:
        ...
        print("Example: 30, 40, 10, 20, 60, 70\n")
...
def update_sales_worksheet(data):
    """
    Update sales worksheeet, add new row with the list data provided.
    """
...
def update_surplus_worksheet(new_surplus_data):
    """
    Update surplus worksheeet, add new row with the list data provided.
    """
